        ...
        for i in range(4):
            for j in range(12):
                for k in range(31):
                    ...
                    strToInsertData = "ALTER TABLE creditbook_sourcelayer.user_details ADD PARTITION (cryear='"+yearList[i]+"',crmonth='"+monthList[j]+"',crday='"+dayList[k]+"') LOCATION '/creditBookDWH/user/cryear="+yearList[i]+"/crmonth="+monthList[j]+"/crday="+dayList[k]+"'"
